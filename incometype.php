...
if (!isset($_SESSION['ID'])) {
 ...
 if(ISSET($_REQUEST['id'])){
		...
		$conn->query("DELETE FROM `incometype` WHERE `id`='$id'") or die("Failed to delete a row!");
...
<div class="row">
	<h3>Add Types Incomes</h3>
	 <div>
	 	
		      </div>
	<form method="post" action="addincometype.php">
	<div class="col-md-10">
	<input type="hidden" name="businessId" value="<?php echo $_SESSION['businessId'];?>">
		<label>Type of Income</label><br/>
		
		<input type="text" name="type" class="form-control" style="width:250px;" required="required"><br/>
		<button type="submit" name="incometype" class="btn btn-success" style="width:200px;" >Save</button>
	</div>
	</form>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="incometype.php?id=<?php echo $fetch['id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
            </div>
